...
Abstract:
This code shows how to create a simple subclass of OperationCustom.
*/
...
/// A sublcass of `OperationCustom` to execute a closure.
class BlockOperationDeng: OperationCustom {
    ...
    /**
        ...
        - parameter block: The closure to run when the operation executes. This
            ...
            block **MUST** be invoked by your code, or else the `BlockOperationDeng`
